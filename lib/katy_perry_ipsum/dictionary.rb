module Dictionary
  WORDS = %w(
    ...
    pony cotton candy fairy tale international smile ghost
    moment momentary minute double single rainbow grace
    graceless tacky little cute adorable turquoise clouds
    )
  SONGS_AS_EXCUSES = [
    "I'm one of the boys", "I kissed a girl", "I woke up in Vegas",
    "Thinking of you", "You're a mannequin", "You're so gay",
    "You're hot then you're cold", "Can you afford me?",
    "I'm lost", "It's self inflicted", "I'm still breathing",
    "Your fingerprints", "I am a teenage dream", "Last Friday night",
    "I am a California girl", "You're a firework", "Show me your peacock",
    "You're circling the drain", "You're the one that got away",
    "You're an alien", "I'm an alien", "Who are you living for?",
    "Who am I living for?", "You're a pearl", "I'm a pearl",
    "You give me that hummingbird heartbeat", "It's not like the movies",
  ]
end